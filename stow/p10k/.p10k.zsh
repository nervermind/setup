# Generated by Powerlevel10k configuration wizard on 2024-08-14 at 09:39 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=197 #103
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%F{197}%n%f@%F{green}%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%F{197}%n%f@%F{green}%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{197}%n%f@%F{green}%m'
